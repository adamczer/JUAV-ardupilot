#!/bin/bash
taskset -c 0 java -Xmx256m -Xms256m -cp ${JUAV_SRC}/juav-hal/juav-hal-sitl/target/juav-hal-sitl-*-jar-with-dependencies.jar ub.cse.juav.copter.HalSitl java $1

#taskset -c 0 java -Xmx256m -Xms256m -cp ${JUAV_SRC}/juav-hal/juav-hal-sitl/target/juav-hal-sitl-*-jar-with-dependencies.jar -Djava.library.path=${JUAV_SRC}/juav-native/juav-native-ardupilot/jni/lib/ ub.cse.juav.copter.HalSitl java $1
