...
public:
    ...
    float juavGetAttitudeAngVelPitchMax() {return _ang_vel_pitch_max;}
    float juavGetAttitudeAngVelYawMax() {return _ang_vel_yaw_max;}
    Vector3f juavGetAttitudeRateTargetAngVel() {return _rate_target_ang_vel;}
    float juavGetAttitudeThrustErrorAngle() {return _thrust_error_angle;}
