...
public:
    ...
    bool is_autopilot() const override { return false; }
    bool has_user_takeoff(bool must_navigate) const override { return true; }
    void juavLoiterRunPriorToAttitudeControl();
    void juavLoiterRunAfterAttitudeControl();
    float juavLoiterGetTargetYawRate();
    float juavLoiterGetTargetPitch();
    float juavLoiterGetTargetRoll();
...
public:
    ...
    bool allows_arming(bool from_gcs) const override { return true; };
    bool is_autopilot() const override { return false; }
    void juavRunBeforeStabilizationCallAttitudeController();
    void juavRunAfterStabilizationCallAttitudeController();
    float juavStabilizeGetTargetYawRate();
    float juavStabilizeGetTargetPitch();
    float juavStabilizeGetTargetRoll();
